...
export class AuthService {
  ...
  ///Metodo valida usuario administrador
  async validadorAdmin(): Promise<boolean> {
    const authenticatedUser = await this.leerUsuarioAutenticado();
    return authenticatedUser?.nombre.toLowerCase() === 'admin';
  }
